...
Time is 23:18, i'm in my room
/////////

/////////
date:  02.06.2023

TIme is 16:24, i'm in station.
/////////
...
Interesting things is going on.
//////////
...
front of one of them is ready.
And write a code, IN Sha Allah.
//////////
...
Time is 23:03, Naruto shirt is done. 5 styles remains.
//////////
...
Time is 22:58. Today i almost completed HDP post desing.
///////////
...
I added delete button to Trafic system project's title section. Design is remaining
/////////
...
I checked meme Project's documantation. There's some things that i couldn't understand. I'll try my best To finish the project. In Sha Allah.
/////////
...
Today i should learn Typescript tricks. I checked one of them. return type.
...
Time is 14:19 i'm in station right now.
Yesterday i messed up with the code.
...
Turn's out there's a way to deploy backend app to vercel, right now i'm trying it. It didn't work. If be hones , nothing worked.
I should use sqlite instead of prisma , that's it.
...
Learn a lil bit of prisma relation quaries.
...
Added 5 questions and answers to JOB INTERVIEW project. 5 remains.
...
I didn't finish the whole thing but first account section is done, Alhamdulillah. Time is 22:52 btw.
...
Time is 23:39. I added Service section to HBS project.
...
First i tought <a> Tag sends GET request in deafult. But it doesn't send that. Now i need to figure out how to send GET request with <a> tag or change it with form button
